...
export const MyProfile = () => {
  ...
  const [userData, setuserData] = useState({
    ...
    email:'rajkumarcse@gmail.com',
    phone:'+91 6379342996',
    address:{
      line1:" 3-36, Ambethkar Street",
      line2:"Omalur, Salem"
    },
    genter:"Male",
    dob:"2000-05-10"
  ...
  return (  
    <div className='max-w-lg flex flex-col gap-2 text-sm '>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700 '>
          <p className='font-medium'>Genter:</p>
          {
            isEdit ? <select className='max-w-20 bg-gray-100' onChange={ e => setuserData(prev => ({...prev, genter: e.target.value}))} value={userData.genter}>
              <option value="Male">Male</option>
              <option value="Female">Female</option>
            </select>
            : <p className='text-gray-400'>{userData.genter}</p>
          }
