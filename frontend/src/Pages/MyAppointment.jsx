...
export const MyAppointment = () => {
  ...
  return (
    <div>
        ...
        <div>
          {
            doctors.slice(0,3).map((item, intex) => (
              <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={intex}>
                <div>
                ...
                <div className='flex-1 text-sm text-zinc-600'>
                  ...
                  <p className='text-xs mt-1'><span className='text-neutral-700 text-sm font-medium'>Date & Time</span>04, Oct, 2024 | 8:30 PM</p>
                </div>
